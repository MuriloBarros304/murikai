...
local section_c = { bg = palette.gray2, fg = palette.fg }
...
return {
    normal = {
        ...
        b = { bg = palette.gray3, fg = palette.fg },
        c = section_c
    },
    insert = {
    ...
    inactive = {
        ...
        a = { bg = palette.gray3, fg = palette.beige, gui = 'bold' },
        b = { bg = palette.gray2, fg = palette.beige },
